...
impl TransactionBuilder {
    ...
    pub fn get_settle_all_games_instruction(&mut self , game_id: [u8;16] , user_id: [u8;16],  user_betting_on_id: [u8;16] , session_id: [u8;21] , winner_id: [u8;16] , user_bet_wallet_key: Pubkey ) {
