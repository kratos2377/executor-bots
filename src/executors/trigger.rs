...
pub struct TriggerExecutor<T: AccountProvider> {
    pub name: String,
    pub dry_run: bool,
    ...
    pub dlob_subscriber: Option<DLOBSubscriber>, // Optional subscriber
    ...
    pub runtime_specs_gauge: Option<ObservableGauge>, // Optional gauge
    pub runtime_spec: RuntimeSpec,
    pub mutex_busy_counter: Option<Counter>, // Optional counter
    pub error_counter: Option<Counter>, // Optional counter
    pub try_trigger_duration_histogram: Option<Histogram>, // Optional histogram
