...
pub struct SpotFillerExecutor<T: AccountProvider> {
    ...
    pub dlob_subscriber: Option<DLOBSubscriber>,
    pub user_map: UserMap,
    pub order_subscriber: OrderSubscriber,
    pub user_stats_map: UserStatsMap,
    ...
    pub est_tx_cu_historgram: Option<HistogramValue>,
    ...
    pub jito_bundles_accepted_gauge: Option<GaugeValue>,
    pub jito_bundles_simulation_failure_gauge: Option<GaugeValue>,
    pub jito_dropped_bundle_gauge: Option<GaugeValue>,
    pub jito_landed_tips_gauge: Option<GaugeValue>,
    pub jito_bundle_count: Option<GaugeValue>,
    ...
    pub pyth_price_subscriber: Option<PythPriceFeedSubscriber>, // Optional subscriber
